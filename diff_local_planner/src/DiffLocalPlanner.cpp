#include <diff_local_planner/DiffLocalPlanner.hpp>
#include <pluginlib/class_list_macros.h>
#include <tf2_geometry_msgs/tf2_geometry_msgs.h>

PLUGINLIB_EXPORT_CLASS(diff_local_planner::DiffLocalPlanner, nav_core::BaseLocalPlanner)

namespace diff_local_planner{

DiffLocalPlanner::DiffLocalPlanner() :
  reached_goal_(false),
  initialized_(false)
{
}

DiffLocalPlanner::DiffLocalPlanner(std::string name, tf2_ros::Buffer* tf, costmap_2d::Costmap2DROS* costmap_ros) :
  reached_goal_(false),
  initialized_(false)
{
...
bool DiffLocalPlanner::computeVelocityCommands(geometry_msgs::Twist& cmd_vel)
{
...
bool DiffLocalPlanner::checkCost(int start_idx, int end_idx)
{
...
void DiffLocalPlanner::initialize(std::string name, tf2_ros::Buffer* tf, costmap_2d::Costmap2DROS* costmap_ros)
{
...
bool DiffLocalPlanner::setPlan(const std::vector< geometry_msgs::PoseStamped >& plan)
{
  reached_goal_ = false;
...
int DiffLocalPlanner::findPathPoint(const tf2::Vector3& base_position)
{
  int min_idx = -1;
...
bool DiffLocalPlanner::isGoalReached()
{
